"""
Port configuration utilities for Synthesis component.
...
def get_component_port(component_id: str) -> int:
    ...
    Args:
        component_id (str): The component identifier (e.g., "synthesis", "hermes")
...
def get_synthesis_port() -> int:
    """
    Get the configured port for the Synthesis component.
    
    Returns:
        int: The port number for Synthesis (default 8009)
    """
